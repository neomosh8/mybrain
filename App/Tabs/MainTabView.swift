...
#Preview {
    let container = try! ModelContainer(for: AuthData.self)
    let mockThoughtsViewModel = createMockThoughtsViewModel()
    
    MainTabViewWithMockData(mockThoughtsViewModel: mockThoughtsViewModel)
