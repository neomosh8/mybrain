...
struct HistoryView: View {
    ...
    let historyItems: [HistoryItem] = [
        ...
        HistoryItem(
            title: "SwiftUI vs. UIKit: A Comprehensive Comparison",
            percentage: 65
        ),
        ...
        HistoryItem(
            title: "Leveraging Swift Packages for Modular Development",
            percentage: 81
        ),
        HistoryItem(title: "State Management in SwiftUI", percentage: 87),
        HistoryItem(
            title: "Animations and Transitions in SwiftUI",
            percentage: 79
        ),
        HistoryItem(title: "Securing Your iOS Applications", percentage: 84),
        HistoryItem(
            title: "Integrating Swift with Backend Services",
            percentage: 77
        ),
        HistoryItem(
            title: "Deploying Apps to the App Store: Best Practices",
            percentage: 91
        )
    ]
    var body: some View {
